...
class tmhOAuth
{
     ...
     *
     * @internal param string $method the HTTP method being used. e.g. POST, GET, HEAD etc
     * @internal param string $url the request URL without query string parameters
     * @internal param array $params the request parameters as an array of key=value pairs
     * @internal param bool $with_user whether to include the user credentials when making the request.
     * @return void
     */
