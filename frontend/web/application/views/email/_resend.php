<table style="width: 100%;font-family: Verdana;font-size: 13px;">
  ...
  <tr>
    <td style="background:#FCFCFC;color:#505050;font-size: 12px; padding: 10px 0px 40px 20px;"><a href="<?php echo $link; ?>" style="color:#0086B0;">Ссылка для активации аккаунта</a></td>
  </tr>
  <tr>
    <td>
