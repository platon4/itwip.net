...
<table style="width: 100%;font-family: Verdana;font-size: 13px;">
  ...
  <tr style="background:#F6F6F6;font-size: 17px;color: #0086B0;">
    <td style="padding: 7px 10px;">
        Инициализация процесса смены данных.
    </td>
  </tr>
  <tr>
    <td style="background:#FCFCFC;color: #959595; font-size: 14px;padding-left: 10px;padding-top: 20px;">
       Вы запросили изменение слудющих данных, на новые (указаны ниже):
    </td>
  </tr>
  <tr>
    <td style="background:#FCFCFC;padding: 20px 0px 30px 15px;">
       <table style="color:#959595;font-size: 12px;">
		<?php foreach($change_data as $data) { ?>
         <tr>
           <td style="padding-right:15px;"><b><?php echo $data['text']; ?>:</b></td>
           <td><?php echo Html::encode($data['value']); ?></td>
         </tr>
		 <?php } ?>
       </table>
    </td>
  ...
  <tr>
    <td style="background:#FCFCFC;color:#505050;font-size: 12px; padding: 20px 0px 80px 15px;"><a href="<?php echo $link; ?>" style="color:#0086B0;">Кликните на этот текст, для подтверждения смены</a></td>
  </tr>
  <tr>
    <td>
