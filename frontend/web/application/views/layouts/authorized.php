...
<html>
    <head>
		...
		<noscript><meta http-equiv="refresh" content="0; URL=/incompatibility"></noscript>
    </head>
    <body>
        <div class="wrapper">
...
<?php if(Yii::app()->user->hasFlash('_messages')): ?>
                                <div class="info">
                                    <div class="line_info" style="margin-bottom: 20px;"><?php echo Yii::app()->user->getFlash('_messages'); ?></div>
                                </div>
<?php endif; ?>
<?php echo $content; ?>
                        </div>			  
