...
class AccountsController extends Controller
{
	public $_tw;
	public $_account;
	public $limitList = array(0 => array('title' => '10', 'value' => '10'), 1 => array('title' => '20',
		'value' => '20'), 2 => array('title' => '30', 'value' => '30'), 3 => array('title' => '40',
		'value' => '40'), 4 => array('title' => '50', 'value' => '50'), 5 => array('title' => '100',
		'value' => '100'));
	...
	public function accessRules()
	{
		return array(
			array('allow',
				'actions' => array('recheck', 'index', 'add', 'settings', 'processing', 'reauth'),
				'roles' => array('user'),
			),
	...
	{
		//if(!Yii::app()->user->checkAccess('moderator') AND Yii::app()->user->id != 3)
		// $this->_message('Раздел временно закрыт на реконструкцию.');
