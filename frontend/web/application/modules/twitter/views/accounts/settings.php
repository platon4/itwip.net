...
<div class="block twitterAccountSetting">
    ...
    <div class="block_title"><div class="block_title_inset"><i class="fa fa-wrench"></i> <h5><?php echo Yii::t('twitterModule.accounts', '_twitterAccountSetting_title'); ?></h5></div></div>
    ...
    <div class="block_content">
        ...
        <div id="block_1">
            ...
            <div id="block_1_1">
                ...
                <div id="block_1_1_1"><img src="<?php echo (trim($model->avatar) == "") ? "/i/_default.png" : str_replace("_normal", "", $model->avatar); ?>" alt="" /></div>
