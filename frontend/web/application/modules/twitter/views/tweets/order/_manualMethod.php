<div id="block_manual">
	<div id="block_manual_setting">
		...
		<div id="block_1_6">
			<button class="button" onclick="Twitter.o.filter.save('manual', '<?= $model->_tid ?>');"><?php echo Yii::t('twitterModule.tweets', '_save_filter'); ?></button>
			<button class="button" onclick="Twitter.o.m.d.getWithFilter();"><?= Yii::t('twitterModule.tweets', '_to_pick_up_accounts'); ?></button>
		</div>
	</div>
