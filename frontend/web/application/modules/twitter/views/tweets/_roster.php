...
<div id="_tweetsRoster" class="block editingPosts">
    <div class="block_title">
        <div class="block_title_inset"><i class="fa fa-pencil"></i>
            <h5><?php echo Yii::t('twitterModule.tweets', '_twitterEditingPosts_title'); ?></h5></div>
    </div>
    <div class="block_content">
        ...
        <div id="block_bottom" class="aHidden">
            <?php if($model->isSave() === false) { ?>
                <button class="button" onclick="Tweets.saveRoster(this);">
                    <i class="fa fa-floppy-o"></i> <?php echo Yii::t('twitterModule.tweets', '_save_tweets_to_list'); ?>
                </button>
            <?php } ?>
            <button id="_nextButton" class="button btn_blue" data-href="/twitter/tweets/finality?_tid=<?php echo $model->_tid; ?>" onclick="window.location = this.getAttribute('data-href'); return false;" <?php echo $model->allowPlace() === false ? ' disabled' : ''; ?>><?php echo Yii::t('twitterModule.tweets', '_go_to_place_tweets'); ?>
