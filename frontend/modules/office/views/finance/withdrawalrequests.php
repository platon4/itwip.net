<div id="" class="block">
	<div class="block_title"><div class="block_title_inset"><i class="fa fa-rub"></i> <h5>Вывод средств из системы</h5></div></div>
...
<div class="period">
                    <ul id="_period">
                        <li><span class="block group_input search"><input style="width: 815px;" type="text" placeholder="Поиск платежей по id пользователя" id="setQuery" /><button class="button icon"><i class="fa fa-search"></i></button></span></li>
                    </ul>
</div>
